...
export var raw_data = {
    ...
    'US Equities' : {
        // 'S&P500' : ['ES=F', 'yahoolive', 'CME_ES1', 'quandl_chris', 1],
        // 'DJIA' : ['YM=F', 'yahoolive', 'CME_YM1', 'quandl_chris', 1],
        // 'NASDAQ' : ['NQ=F', 'yahoolive', 'CME_NQ1', 'quandl_chris', 1],
        // 'RUS2K' : ['TF=F', 'yahoolive', 'ICE_TF1', 'quandl_chris', 1],
    },
    'Global Equities' : {
        // 'MSCI Emerging' : ['^GSPC', 'yahoolive', 'EUREX_FMEM1', 'quandl_chris', 1],
        // 'Eurostoxx' : ['^GSPC', 'yahoolive', 'EUREX_FESX1', 'quandl_chris', 1],
        // 'FTSE' : ['^GSPC', 'yahoolive', 'LIFFE_Z1', 'quandl_chris', 1],
        // 'DAX' : ['^GSPC', 'yahoolive', 'EUREX_FDAX1', 'quandl_chris`', 1],
        // 'CAC' : ['^GSPC', 'yahoolive', 'LIFFE_MFC1', 'quandl_chris', 1],
        // 'Nikkei' : ['^GSPC', 'yahoolive', 'CME_NK1', 'quandl_chris`', 1],
        // 'Canada TSX' : ['^GSPC', 'yahoolive', 'MX_SCF1', 'quandl_chris`', 1],
    },
    'Energy' : {
        // 'WTI Crude' : ['CL=F', 'yahoolive', 'ICE_T1', 'quandl_chris', 1],
        // 'Brent Crude' : ['BZ=F', 'yahoolive', 'ICE_B1', 'quandl_chris', 1],
        // 'Natural Gas' : ['NG=F', 'yahoolive', 'CME_QG1', 'quandl_chris', 1],
        // 'Heating Oil' : ['HO=F', 'yahoolive', 'ICE_O1', 'quandl_chris', 1]
    },
    'Metals' : {
        // 'Gold' : ['GC=F', 'yahoolive', 'GOLD', 'quandl_lbma', 1],
        // 'Silver' : ['SI=F', 'yahoolive', 'SILVER', 'quandl_lbma', 1],
        // 'Platinum' : ['PL=F', 'yahoolive', 'PLAT', 'quandl_llpm', 1],
        // 'Copper' : ['HG=F', 'yahoolive', 'CME_HG1', 'quandl_chris', 1]
    },
    'Agriculture' : {
        // 'Corn' : ['C=F', 'yahoolive', 'CME_C1', 'quandl_chris', 1],
        // 'Sugar' : ['SB=F', 'yahoolive', 'ICE_SB1', 'quandl_chris', 1],
        // 'Wheat' : ['W=F', 'yahoolive', 'CME_W1', 'quandl_chris', 1],
        // 'Soybean' : ['S=F', 'yahoolive', 'CME_S1', 'quandl_chris', 1],
        // 'Cotton' : ['CT=F', 'yahoolive', 'ICE_CT1', 'quandl_chris', 1],
        // 'Cocoa' : ['CC=F', 'yahoolive', 'ICE_CC1', 'quandl_chris', 1]
    },
    'Other' : {
        // 'VIX' : ['^VIX', 'yahoolive', 'CBOE_VX1', 'quandl_chris', 1],
        // 'Dollar IDX' : ['DX-Y.NYB', 'yahoolive', 'ICE_DX1', 'quandl_chris', 1]
    },
    'US Rates' : {
        '5Y' : ['^FVX', 'yahoolive', 'YIELD', 'quandl_tsy', 6],
        '10Y' : ['^TNX', 'yahoolive', 'YIELD', 'quandl_tsy', 8],
        '30Y' : ['^TYX', 'yahoolive', 'YIELD', 'quandl_tsy', 10],
    }
