...
export var raw_data = {
    ...
    "Global Equities" : {
        ...
        "FTSE" : ["^FTSE", "yahoolive", "LIFFE_Z1", "quandl_chris", 4, 0.75],
        "DAX" : ["^GDAXI", "yahoolive", "EUREX_FDAX1", "quandl_chris", 4, 0.75],
        "CAC" : ["^FCHI", "yahoolive", "LIFFE_MFC1", "quandl_chris", 4, 0.75],
        "Nikkei" : ["^N225", "yahoolive", "CME_NK1", "quandl_chris", 4, 0.75],
        "Hang Seng" : ["^HSI", "yahoolive", "HKEX_HSI1", "quandl_chris", 4, 0.75],
        "Kospi" : ["^KS11", "yahoolive", "", "quandl_chris", 4, 0.75],
        "Canada S&P/TSX" : ["^GSPTSE", "yahoolive", "MX_SCF1", "quandl_chris", 7, 0.75],
        "Ibovespa" : ["^BVSP", "yahoolive", "CME_IBV1", "quandl_chris", 4, 0.75],
    },
    "Energy" : {
